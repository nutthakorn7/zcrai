    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] flex flex-col items-center z-10">
        ...
        <div className="mb-8 flex flex-col items-center gap-4 text-center">
          ...
          <div className="mt-2">
            <h1 className="text-4xl font-bold font-display tracking-tight mb-2 text-foreground">
              {requireMFA ? 'Security Check' : (isSSO ? 'Single Sign-On' : 'Welcome Back')}
            </h1>
            <p className="text-foreground/60 text-sm font-medium">
              {requireMFA 
                ? 'Enter the 6-digit code from your authenticator' 
                : (isSSO ? 'Enter your Organization ID to continue' : 'Sign in to your zcrAI account')}
            </p>
          </div>
             ...
             !requireMFA ? (
               isSSO ? (
                  ...
                  <div className="space-y-5 animate-fade-in">
                      ...
                      <div className="flex flex-col gap-3 mt-4">
                          <Button 
                              type="submit" 
                              isLoading={isLoading}
                              className="h-[50px] bg-primary hover:bg-primary/90 text-background font-bold tracking-wide shadow-[0_0_20px_rgba(0,216,255,0.3)] font-display"
                          >
                  ...
                  <div className="flex flex-col gap-3 mt-4">
                      ...
                      type="submit" 
                      isLoading={isLoading}
                      className="h-[50px] bg-primary hover:bg-primary/90 text-black font-bold font-display tracking-tight shadow-[0_0_20px_rgba(0,216,255,0.3)]"
