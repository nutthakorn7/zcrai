  ...
  return (
    <div className="p-6 h-full flex flex-col gap-6 w-full">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold font-display text-foreground tracking-tight">AI Command Center</h1>
          ...
          <Card key={i} className="bg-content1/50 border border-white/5 shadow-sm">
            <CardBody className="p-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className={`text-xl font-bold font-display text-${stat.color}`}>{stat.value}</div>
