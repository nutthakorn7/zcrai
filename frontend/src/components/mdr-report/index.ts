// MDR Report Components
// These components are designed for PDF generation via Puppeteer

export { MdrCoverPage } from './MdrCoverPage'
export { MdrAttentionPage } from './MdrAttentionPage'
export { MdrTableOfContents } from './MdrTableOfContents'
export { MdrOverviewSection } from './MdrOverviewSection'
